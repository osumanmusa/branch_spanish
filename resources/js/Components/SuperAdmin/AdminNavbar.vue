...
const submit = () => {
    modalform.post(route("superadmin.category.store"));
};
...
<template>
    <header
        class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-yellow-400"
    >
    ...
    <img v-else class="object-cover w-full h-full" :src="'/img/profile-img/'+ $page.props.auth.user.profile_image"  alt="Your avatar">
            ...
            <div x-data="{ notificationOpen: false }" class="relative">
                <Link
                    ...
                    method="post"
                    as="button"
                    class="flex mx-4 text-gray-600 focus:outline-none overflow-hidden"
                >
                    <svg
                        fill="#000000"
                        height="30px"
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="p-2">
                                ...
                                <input
                                    ...
                                    aria-describedby="user_avatar_help" required
                                />
                            </div>
                        </div>
                        <!-- Modal footer -->
