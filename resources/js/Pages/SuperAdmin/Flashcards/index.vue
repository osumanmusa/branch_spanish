                    ...
                    <div class="mx-auto py-8 max-w-screen-xl lg:px-3">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <a
                                        href="/superadmin_create_flashcard"
                                        ...
                                        >
                                            <g
                                                style="
                                                    ...
                                                    opacity: 1;
                                                "
                                                transform="translate(46.02023346303501 36.05914396887157) scale(2.03 2.03)"
                                            >
                                                <path
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <td
                                                class="px-6 py-4 border text-center text-sm text-gray-800 dark:text-gray-200"
                                            >
                                                {{ f.flashcard_frontcontent }}
                                            </td>
                                            <td
                                                class="px-6 py-4 border text-center text-sm text-gray-800 dark:text-gray-200"
                                            >
                                                {{ f.flashcard_backcontent }}
                                            </td>
                            ...
                            <i class="fa fa-pencil fa-solid" aria-hidden="true"></i> Edit
                                                ...
                                                <a
                                                    class="p-3 text-red-500 hover:text-red-200"
                                                    v-bind:href="
                                                        route(
                                                            'superadmin.deleteflashcards',
                                                            f.id
                                                        )
                                                    "
                                                >
