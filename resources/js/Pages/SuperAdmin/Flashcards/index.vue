...
const submit = () => {
    form.get('/superadmin/flashcards');
  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3">
    ...
    <li>
      ...
      <i class="fa fa-angle-left fa-bold"></i>
        <a href="/superadmin/flashcards" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Flashcards</a>
      </div>
    </li>
  </ol>
</nav>
                      ...
                      <tr v-for="f in flashcards.data" :key="f.id" class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border whitespace-nowrap text-center text-sm font-medium">
                         <!-- <Link class="p-2 text-blue-500 hover:text-blue-200" v-bind:href="route('admin.editflashcards', f.id)">
                          ...
                          <a class="p-3 text-red-500 hover:text-red-200" v-bind:href="route('superadmin.deleteflashcards', f.id)">
