  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3">
    ...
    <li>
      ...
      <i class="fa fa-angle-left fa-bold"></i>
        <a href="/superadmin/quiz" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Quiz</a>
      </div>
    </li>
  </ol>
</nav>
        ...
        <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="/superadmin/create_quiz" class="flex py-3 px-4 inline-flex text-right gap-2 items-center justify-center rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800">
                      Add Quiz
                  </a>
                </div>
            </div>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                      <tr v-for="c in categories.data" :key="c.id" class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border whitespace-nowrap text-center text-sm font-medium">
                         <Link class="p-2 text-blue-500 hover:text-blue-200" v-bind:href="route('superadmin.viewquiz', c.id)">
                            <i class="fa fa-eye fa-solid" aria-hidden="true"></i> view
                          </Link>
                          <a class="p-3 text-red-500 hover:text-red-200" v-bind:href="route('superadmin.deletequiz', c.id)" >
            ...
            <pagination class="justify-end" :links="categories.links"/>
        </div>
    </div>
