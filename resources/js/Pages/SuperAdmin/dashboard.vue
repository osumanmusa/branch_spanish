        ...
        />
                    ...
                    <div class="mb-4 border-b border-gray-200 dark:border-gray-700 mt-6">
                        <ul class="flex -mb-px text-sm font-medium text-center" >
                            <li class="mr-2" >
                                <button @click="liststudent" class="register inline-block py-2 px-6 bg-color text-white hover:bg-blue-50 text-sm hover:text-white border border-primary font-bold transition duration-200" >
                                    Students</button>
                            </li>
                            <li class="mr-2">
