  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3">
    ...
    <li>
      ...
      <i class="fa fa-angle-left fa-bold"></i>
        <a href="/superadmin/students" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">Students</a>
      </div>
    </li>
  </ol>
</nav>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                      <tr v-for="s in students.data" :key="s.id" class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border text-center text-sm text-gray-800 dark:text-gray-200">
                         ...
                         <Link class="p-2 text-blue-500 hover:text-blue-300 flex justify-center inline-block" v-bind:href="route('superadmin.viewstudent', s.id)">
