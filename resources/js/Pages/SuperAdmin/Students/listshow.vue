...
<template>
    ...
    <div class="mx-auto py-8 max-w-screen-xl lg:px-3">
        ...
        <div class="bg-white dark:bg-gray-800 relative sm:rounded-lg overflow-hidden">
              ...
              <table class="w-full text-sm text-left border border-b text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-center text-gray-700 items-center border border-b uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="lg:px-4 lg:py-3 border ">Quiz Category</th>
                            <th scope="col" class="lg:px-4 lg:py-3 border ">score</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                      <tr v-for="s in studentquiz.data" :key="s.id" class="hover:bg-gray-100">
                        ...
                        <td class="px-6 py-4 border text-center text-sm text-gray-800 dark:text-gray-200">{{s.category_name}} </td>
                        ...
                        <td class="px-6 py-4 border text-center text-sm text-gray-800 dark:text-gray-200">
                           ...
                           <Link :href="route('superadmin.getstudentdetails', [s.id, s.s_category_id,s.user_id,s.quiz_attempt])"  class="p-2 text-blue-500 hover:text-blue-300 flex justify-center inline-block" >
            ...
            <pagination class="justify-end" :links="studentquiz.links"/>
        </div>
    </div>
