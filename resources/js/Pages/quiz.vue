                ...
                <div class="flex flex-col">
                    <div class="container px-4">
                        <div class="flex flex-wrap">
                            ...
                            >
                            <h1 class="text-white text-5xl font-bold">Quiz Me </h1>
            
                            <!-- Description -->
                            <p class="text-white text-xl font-light pt-4">
                                We are coming to test you on the various lessons we
                                practiced together and we need you to select a card and
                                begin the quiz
                            </p>
                    ...
                    <div class="container px-4">
                        <div class="flex flex-wrap">
                            ...
                            <div
                                ...
                                :key="c.id"
                                class="w-full md:w-6/12 lg:w-3/12 mb-6 px-1 sm:px-6 lg:px-4"
                            >
                                <div class="flex flex-col">
                                    <!-- Avatar -->
                                    <a
                                        v-bind:href="route('quiz.show', c.id)"
                                        class="mx-auto"
                                    >
                                        <img
