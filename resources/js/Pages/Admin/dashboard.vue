        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-white">
                <div class="container mx-auto px-6 py-8">
                    ...
                    >
                        <ul class="flex -mb-px text-sm font-medium text-center">
                            ...
                            <li class="mr-2">
                                <button
                                    @click="listparent"
                                    class="inline-block p-4 py-2 px-6 bg-white text-gray-400 hover:bg-blue-50 text-sm hover:text-white border border-default font-bold transition duration-200"
                                >
                                    Parents
                                </button>
                            </li>
                    ...
                    <div
                        v-if="studentlist"
                        class="mx-auto max-w-screen-l lg:px-3"
                    >
                        <!-- Start coding here -->
                        <div
