                                        ...
                                        <tr v-for="c in child" :key="c.id" class="hover:bg-gray-100">
                                            ...
                                            >
                                                  <span v-if="c.student_status == null" class="text-yellow-400">
                                                    <b>Processing</b></span>
                                                  <span v-else>{{ c.student_status}}</span>
                                            </td>

                                            <td
                                                class="px-6 py-4 border whitespace-nowrap text-center text-sm font-medium"
                                            >
                                                <Link v-bind:href="route('parent.viewstudent', c.id)"
